...
from datetime import datetime   #only used to grab timestamp
...
class printp(plugins.Plugin):
    __author__ = 'Code taken from HannaDiamond's Pwnagotchi Age script'
    __version__ = '1.0.0'
    __license__ = 'GPLv3'
 ...
 #       self.train_epochs = 0
    ...
    ### Print to the View (text blurb) area of the Pwnagotchi
    def on_epoch(self, agent, epoch, epoch_data):
        view = agent.view()
        view.set('face', faces.HAPPY)   #Optional if you want to change the face
